...
/**
 * @brief the function is getting a scan code that the user can provide from its keyboard and print something special for example backspace
*/
void printSpecial(int scanCode);



//void printGeneralPurposeRegister();